...
public class DynamicRVAdapterCompra extends  RecyclerView.Adapter<DynamicRVAdapterCompra.DynamicRVViewHolder> implements View.OnClickListener{

    List<DynamicRVModelCompra> item;
    private View.OnClickListener listener;

    public DynamicRVAdapterCompra(List<DynamicRVModelCompra> items) {
        this.item = items;
        notifyDataSetChanged();

    }

    public void setFilteredList(List<DynamicRVModelCompra>dynamicRVModelList){
    ...
    public void onBindViewHolder(@NonNull DynamicRVViewHolder holder, int position) {
        ...
        DynamicRVModelCompra currentItem = item.get(position);
